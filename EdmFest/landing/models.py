...
class Artist(models.Model):
    ...
    first_name = models.CharField(max_length=150,null=False,default='',blank=False)
    is_active = models.BooleanField(null=True,blank=True)
    last_name = models.CharField(max_length=150,null=True,blank=True)
    stage_name = models.CharField(max_length=150,null=False,default='',blank=False)
...
class Festival(models.Model):
    ...
    last_year = models.PositiveIntegerField(null=False,default='',blank=False)
